...
<head>
    ...
    <link href="{{asset('assets/css/demo11/pages/general/login/login-1.css')}}" rel="stylesheet" type="text/css" />
...
{{--    <link href="{{asset('assets/css/demo11/skins/header/base/light.css')}}" rel="stylesheet" type="text/css" />--}}
{{--    <link href="{{asset('assets/css/demo11/skins/header/menu/light.css')}}" rel="stylesheet" type="text/css" />--}}
{{--    <link href="{{asset('assets/css/demo11/skins/brand/dark.css')}}" rel="stylesheet" type="text/css" />--}}
{{--    <link href="{{asset('assets/css/demo11/skins/aside/dark.css')}}" rel="stylesheet" type="text/css" />--}}
...
<!-- begin::Body -->
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading" style="padding: 0">
                    ...
                    <div class="kt-login__form">
                        ...
                        <form class="kt-form" action="{{route('admin.login')}}" method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="email" placeholder="البريد الالكتروني" value="{{old('email')}}" name="email" autocomplete="on">
                            </div>
                            <div class="form-group">
...
{{--                                    Forgot Password ?--}}
{{--                                </a>--}}
                                <button type="submit" class="btn btn-primary btn-elevate kt-login__btn-primary">تسجيل دخول</button>
                            </div>
...
<script src="{{asset('assets/js/demo11/pages/login/login-1.js')}}" type="text/javascript"></script>
